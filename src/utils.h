...
namespace bisam {
    ...
    public:
        ...
        void print_function_summary() const {
            ...
            std::cout << std::endl << std::left << std::setw(max_name_length + 2) << "Function Name" <<
                    "| Execution Time"
                    << std::endl;
        ...
        void end_section(const std::string &name) {
            ...
            section.total_duration += std::chrono::duration_cast<std::chrono::nanoseconds>(
