...
void Atvecx_int(const int *A, const double *x, double *z, int rowini, int rowfi, int colini, int colfi);
...
void rnlpPost_lm_custom(double *ans, int niter, int burnin, int thinning, double *y, int *x, int n, int p, int r, double tau,
