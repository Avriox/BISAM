...
SEXP modelSelectionEnumCI(SEXP Snmodels, SEXP Smodels, SEXP Sknownphi, SEXP Sfamily, SEXP SpriorCoef, SEXP SpriorGroup,
  ...
  set_marginalPars(&pars,
                   ...
                   REAL(SytX),
                   INTEGER(Smethod),
                   INTEGER(Sadjoverdisp),
                   INTEGER(Shesstype),
                   INTEGER(SoptimMethod),
                   INTEGER(Soptim_maxit),
                   &usethinit,
                   thinit,
                   INTEGER(SB),
                   REAL(Salpha),
  ...
  modelSelectionEnum(postMode,
                     postModeProb,
                     postProb,
                     INTEGER(Snmodels),
                     INTEGER(Smodels),
                     INTEGER(SpriorDelta),
                     INTEGER(SpriorConstr),
                     INTEGER(Sverbose),
                     &pars);
  ...
  for (i = ilow, itercount = 0; i < iupper; i++, itercount++) {
    ...
    while (j < *(*pars).p) {
      if (sample[jgroup] > 0) {
        ...
        validmodel = checkConstraints(addgroups,
                                      &naddgroups,
                                      dropgroups,
                                      &ndropgroups,
                                      constraints,
