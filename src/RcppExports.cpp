...
// modelbinomprior
List modelbinomprior(double p);
RcppExport SEXP _BISAM_modelbinomprior(SEXP pSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< double >::type p(pSEXP);
    rcpp_result_gen = Rcpp::wrap(modelbinomprior(p));
    return rcpp_result_gen;
END_RCPP
}
// igprior
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_BISAM_modelbinomprior", (DL_FUNC) &_BISAM_modelbinomprior, 1},
