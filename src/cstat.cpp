...
// JAKOB This is our own RNLP related stuff
// [[Rcpp::export]]
Rcpp::NumericVector rnlp_wrapper(
    ...
    try {
        ...
        // Call the C++ function
        rnlpPost_lm_custom(ans.begin(), niter, burnin, thinning, y.begin(), x.begin(), n, p, r,
...
void
rnlpPost_lm_custom(double *ans, int niter, int burnin, int thinning, double *y, int *x, int n, int p, int r, double tau,
