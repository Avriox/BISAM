...
if (split_x && (is.null(n_observations) || is.null(n_timeperiods))) {
    stop("When split_x=TRUE, n_observations and n_timeperiods must be provided")
  }

# JAKOB If I am not mistaken, this result is never used for our use case but takes a long time to calculate
#   usethinit = 0
#   thinit = rep(0,ncol(xstd))
#   if(calc_thinit){
